...
import { RENTABILITE_TABS } from "@/config/rentabilite-tabs";

export function RentabiliteTabs() {
      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6">
        <div className="flex items-center gap-3 py-3">
          <div className="shrink-0">
            ...
            <p className="text-sm font-bold text-neutral-950 leading-tight">Rentabilité</p>
          </div>
